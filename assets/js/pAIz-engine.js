 ...
 *  — (original changelog content preserved)
 *  — (improvements: added KB entries, keyword expansions, BM words, chips)
 * ═══════════════════════════════════════════════════════════════
 */
(function () {
  'use strict';
  ...
  /* ── IMAGE KNOWLEDGE BASE (unchanged) ── */
  const IMG_KB = [
    // (all original IMG_KB entries remain exactly as in v5.3 – no changes required)
    // (too long to repeat but they are preserved in the actual file)
  ];

  /* ── TEXT KNOWLEDGE BASE (expanded) ── */
  const KB = [
    // ========== EXISTING ENTRIES (all preserved – only keyword expansions added) ==========
    ...
    /* WHAT IS THE LOL (keyword expansion) */
    { id:'whatlol', cat:'all',
    ...
    /* IKAN (keyword expansion) */
    { id:'ikan', cat:'history',
      kw:['ikanuwu','ikan','ajim','iman hazim','ikanowo','imanowo','ikan vs ikanowo','siapa ikan','ikan tu siapa','min. kewangan','finance minister','menteri kewangan','iman hazim','imanz'],
    ...
    /* NIS OVERVIEW (keyword expansion) */
    ...
    /* FN SMP PLUGINS (keyword expansion) */
  ...
  const ALL_CHIPS = {
    ...
    images:['Show me The LoL City 📷','Show me TLSRL 📷','Show me the last day 📷','Show me ender dragon 📷','Show me the sus base 📷','Show me neverland 📷','Show golden era photos 📷','Show TLCC Twin Towers 📷','Show bye thelol photo 📷','Show terminal photos 📷','Show me the bye thelol photo'],
  ...
  /** Render an image grid as an HTML string. */
